    ...
    <main className="container p-7">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                ...
                <button className="bg-red text-blue py-3 px-7 text-xs tracking-widest font-semibold">READ MORE</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid md:grid-cols-3 gap-5 mt-7">
        <div className="md:col-span-1 flex gap-5">
          <Image src={TopLaptops} alt="Top Laptops" quality={100} />
          <div className="flex flex-col gap-2">
            <h2 className="text-red text-2xl font-bold">01</h2>
            <h3 className="text-blue text-base font-bold">Reviving Retro PCs</h3>
